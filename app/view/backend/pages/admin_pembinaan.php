...
<div class="container mb-5">
    <h3 class="text-primary mb-3">DAFTAR PERMINTAAN PEMBINAAN</h3>
    <div class="card mb-5">
        <div class="card-header">
            ...
            <div>
                ...
                <a class="btn btn-success btn-sm" href="<?= route('admin_pembinaan') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="auto" class="text-center"><?= date('Y-m-d', $row['create_at']) ?></td>
                                ...
                                <td width="auto" class="text-center">
                                    <div>
                                        <!-- button view data -->
                                        <a href="<?= route('admin_pembinaan_view', strval($row['id'])) ?>" class="btn btn-info btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?= route('admin_pembinaan_delete', strval($row['id'])) ?>" class="btn btn-success btn-sm">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
