<div class="container my-3">
    <h3 class="text-primary pt-3 mb-3">DAFTAR PENGGUNA</h3>
    <div class="card">
        <div class="card-header">
            ...
            if ($q) { ?>
                <div class="alert alert-success alert-dismissible fade show mt-2" role="alert">
                    ...
                    <div class="filter-info">
                        ...
                        </svg> Nama atau Alamat Email mengandung kata '<?= $q ?>'<br />
                    </div>
            ...
            <div>
                ...
                <a class="btn btn-success btn-sm" href="<?= route('admin_user') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label" for="id_q">Nama atau Alamat Email</label>
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="auto" class="text-center">
                                    <div>
                                        <!-- button view data -->
                                        <a href="<?= route('admin_user_view', strval($row['id'])) ?>" class="btn btn-info btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <!-- button ubah data -->
                                        <a href="<?= route('admin_user_edit', strval($row['id'])) ?>" class="btn btn-warning btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-start">
                                                        <p class="mb-2">Yakin akan menghapus pengguna ini?</p>
                                                        <!-- informasi data yang akan dihapus -->
                                                        <p class="fw-bold mb-2"><?= $row['nama'] ?> <span class="fw-normal">-</span> <?= $row['email'] ?></p>
                                                    </div>
                                                    <div class="modal-footer">
