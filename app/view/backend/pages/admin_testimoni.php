<div class="container my-3 mb-5">
    <h3 class="text-primary pt-3 mb-3">DAFTAR TESTIMONI PENGGUNA</h3>
    <div class="card">
        <div class="card-header">
            ...
            <div>
                ...
                <a class="btn btn-success btn-sm" href="<?= route('admin_testimoni') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="table-responsive">
                <table id="myTable" class="table table-bordered table-striped table-hover" style="width:100%">
                    <thead class="table-light">
                        ...
                        <th class="text-center">Instansi/Jabatan</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="auto"><?= $row['nama'] ?></td>
                                <td width="auto"><?= $row['instansi'] ?><br><span class="text-muted"><?= $row['jabatan'] ?></span></td>
                                <td width="auto"><?= $row['pesan'] ?></td>
                                <td width="auto">
                                    <div>
                                        <?php for ($j = 0; $j < 5; $j++) {
                                            if ($j < $row['rating']) {
                                ...
                                <td class="text-center" width="100">
                                    <div>
                                        <!-- button ubah data -->
                                        <a href="<?= route('admin_testimoni_edit', $row['id']) ?>" class="btn btn-warning btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <div class="modal fade" id="modalHapus<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalHapusLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus testimoni</h1>
                                                    </div>
                                                    <div class="modal-body text-start">
                                                        <p class="mb-2">Yakin akan menghapus testimoni ini?</p>
                                                        <!-- informasi data yang akan dihapus -->
                                                        <p class="fw-bold mb-2"><?= $row['nama'] ?> - <?= $row['pesan'] ?></p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?= route('admin_testimoni_delete', $row['id']) ?>" class="btn btn-success btn-sm">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
